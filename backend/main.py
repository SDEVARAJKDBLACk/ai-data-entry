...
# Using stable model to avoid 404
...
def home():
    ...
    <html><body style="background:#0b0f1a; color:white; padding:50px; font-family:sans-serif; text-align:center;">
        <div style="max-width:500px; margin:auto; background:#1e293b; padding:30px; border-radius:20px; border:1px solid #334155;">
            ...
            <textarea id="t" style="width:100%; height:120px; background:#020617; color:white; border-radius:10px; padding:10px; margin-bottom:15px;" placeholder="Paste text here..."></textarea>
            <input type="file" id="f" style="margin-bottom:20px; display:block; width:100%;">
        ...
        <script>
            async function run() {
                const b = document.getElementById('btn'); b.innerText = "Analyzing..."; b.disabled = true;
